...
# Using stable, well-tested versions for maximum compatibility
...
# Use stable release tag instead of unstable develop branch
# This is critical for build reliability
